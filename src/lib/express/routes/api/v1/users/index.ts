...
export const get = [
  ...
  query('user_ids')
    ...
    .custom(value => value.every((id: unknown) => typeof id === 'string' && id.length >= 17 && id.length <= 19)).withMessage('user_ids must be an array of strings with 17-19 characters long.')
